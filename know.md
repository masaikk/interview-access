...
<html>
    ...
    <body>
        ...
        <script>
            ...
            var ws = new WebSocket(`ws://localhost:8899/ws/${client_id}`);
...
其中值得关注的代码也类似于nestjs中的使用一个列表来记录websocket实例并且forEach发送
...
![image-20230121141257327](know.assets/image-20230121141257327.png)
